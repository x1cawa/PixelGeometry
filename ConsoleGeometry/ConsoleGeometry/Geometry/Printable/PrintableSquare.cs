...
namespace ConsoleGeometry.Geometry.Printable
{
    public class PrintableSquare : AbstractPrintableFigure
    {
        ...
        public override ConsoleColor Color { get => rect.Color; set => rect.Color = value; }

        public PrintableSquare(int width, ConsoleColor color) { rect = new PrintableRect(width, width, color); }
